...
## 关联补充：PraisonAI — Production-Ready Multi-Agent Framework

> 以下内容作为 Multi-Agent 框架选型的补充参考。

**PraisonAI 定位**：
- 轻量级 Multi-Agent 框架
- 支持 Role-Based Agent 协作
- 与 MCP 工具生态集成
- 适合快速原型验证

**与协议栈的关系**：PraisonAI 主要解决 Agent 内部编排问题，其之上仍需 A2A/MCP 解决跨系统通信。

> 项目地址：https://github.com/PraisonAI/PraisonAI

---

## 关联补充：Deloitte 企业视角 — Agent 间协议竞争格局

**行业预测（Gartner）**：2028 年 33% 企业软件将包含 agentic AI（2024 年不足 1%）。
...
**关键风险**：可能形成"围墙花园"，企业被锁定在单一协议生态。

**预测**：2027 年这些协议将开始收敛，形成 2-3 个主导标准。

> 来源：Deloitte AI Agent Orchestration 企业落地指南
