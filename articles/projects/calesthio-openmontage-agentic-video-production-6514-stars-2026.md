...
> OpenMontage（6,514 Stars）是全球首个开源 Agentic 视频生产系统——12 条生产管线、52 种工具、500+ Agent 技能，把 Claude Code / Cursor / Copilot 变成完整的视频制作团队。成本：$0.69 生成一条广告。
...
```yaml
工具类别:
  素材获取:     Unsplash API, Pexels API, Shutterstock API, AI Image Gen (DALL-E/Midjourney)
  音频处理:     ElevenLabs TTS, Adobe Podcast Enhance, SFX Library
  视频剪辑:     FFmpeg wrappers, Shotcut API, DaVinci Resolve scripting
  特效:         Remotion, After Effects template automation, Lottie animations
  字幕:         Whisper transcription, translation APIs
...
3. "A full video production team. 49 tools. $0.69 per ad. Zero humans." — LinkedIn / FastCode

---

*本文属于 projects 目录，推荐关联 Article：OpenAI Workspace Agents（同一主题：Agentic Workflow 全流程自动化）。*
