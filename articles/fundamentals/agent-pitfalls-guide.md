...
## 关联补充：七种设计模式（来源：Machine Learning Mastery）

> 以下内容作为 Agent 设计模式的参考补充。

### 七种关键 Agentic AI 设计模式

| 模式 | 描述 | 适用场景 |
|------|------|----------|
| **ReAct** | 推理 + 行动交替 | 工具调用任务 |
| **Plan-and-Solve** | 显式规划阶段 | 复杂多步骤任务 |
| **Reflexion** | 自我反思修正 | 试错学习场景 |
| **Self-Correcting** | 结果验证 + 回退 | 高可靠性需求 |
| **CoT (Chain of Thought)** | 链式推理 | 复杂推理任务 |
| **Tree of Thoughts** | 树状探索 | 创意/搜索任务 |
| **Module组装** | 多模型/技能组合 | 企业复杂场景 |

> 完整模式分析见原文：https://machinelearningmastery.com/agentic-ai-design-patterns/
