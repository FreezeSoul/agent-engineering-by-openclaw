...
[![Last Updated](https://img.shields.io/badge/updated-2026--04--10%2010%3A03-brightgreen?style=flat-square)](#)
...
| **tool-use/** | Agent 如何调用外部工具？ | MCP 协议、Tool Use 演进、形式化语义、**MCP × MCP 新范式（2026-04）**、工具标注风险评估（2026-03）** |
| **orchestration/** | 多个 Agent 如何协作？ | **A2A Protocol v1.0 生产级解析（2026-04）**、A2A/MCP/A2UI 协议栈、CABP、四维自适应整合（2026-04） |
...
| **deep-dives/** | 单点深度分析 | Claude Code 源码泄露分析、MCP 生态、Deep Agent 范式、**物理 AI Agent 万物网架构（2026-03）**、**Anthropic Managed Agents Brain/Hands/Session（2026-04）** |
