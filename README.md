...
[![Last Updated](https://img.shields.io/badge/updated-2026--03--23%2023%3A01-brightgreen?style=flat-square)](digest/weekly/2026-W13.md)
...
| 框架 | 核心定位 | 快速开始 |
|------|---------|---------|
| [LangChain](frameworks/langchain/) | LLM 应用框架，生态最全 | [Quickstart →](frameworks/langchain/overview.md) |
...
### 📅 本周 · 2026-W13（进行中）
🔴 **OpenClaw CVE-2026-25253 安全危机（CVSS 8.8）：WebSocket 令牌窃取 + 一键 RCE + ClawHavoc 供应链攻击（341 个恶意 Skills）；当前版本 2026.3.13 已修复** / **LangSmith Fleet：LangChain Agent Builder 重命名为企业级多 Agent 治理平台（权限 + 凭证管理）** / **MCP "Rise & Relative Fall"：Andrew Baker 深度分析——双跳延迟、上下文膨胀、安全事件爆发，但 Linux Foundation 已标准化** / **LangChain × NVIDIA 联合发布企业级 Agentic AI 平台** / Meta AI Agent 触发 Sev 1 安全事故 / Claude Opus 4.6：1M Context + Agent Teams / Jensen Huang：2036 年每人有 100 个 Agent / NIST 启动 AI Agent Standards / LangChain 生态圈多 repo 归档 / Computer-Use 能力拐点 / **"Agents of Chaos" 多 Agent 红队实验实证 / USC 证实 AI 可自主协调散布虚假信息** / **MCP 2026 路线图：Agent Communication 列为优先领域** / **SurePath AI MCP Policy Controls 企业安全产品落地** / **NVIDIA NemoClaw 企业级 Agent 平台 / Anthropic Claude Code Review 多 Agent 并行 PR 审查 / OpenAI Codex Security 审计百万 Commit / Microsoft Copilot Cowork 牵手 Anthropic** / **Ramp AI Index：Anthropic 首次在企业 AI 采购中全面超越 OpenAI（赢得 70% 首次买家）** / **MCP SDK v1.27 详解：TypeScript Auth 修复 + Python 状态码规范化 + OpenAI Agents SDK MCP 错误标准化** / **RSAC 2026 开幕：Agentic AI 安全成核心议题，Token Security 入选 Innovation Sandbox 十强** / **OWASP Top 10 for Agentic 2026 正式发布：ASI01-ASI10 安全风险框架（RSAC Day 1）** / **Microsoft AI Toolkit for VS Code v0.32.0：AI Toolkit + Foundry 统一** / **腾讯 ClawBot：OpenClaw 入驻微信十亿用户** / **AWS+SailPoint 合推企业 AI Agent 身份治理方案 / McKinsey：62% 企业正在试验 AI Agent** / **MCPwned：Azure MCP 服务器 RCE 漏洞（RSAC Day 1）** / **CrewAI v1.10.2a1→v1.11.0：gitpython CVE 修复、沙盒逃逸修复、ContextVars 跨线程传播** / **RSAC Day 2：Cisco 揭示 Agent 四阶段演进路线图（Change Agents）** / **RSAC Day 2：Charm Security 赢得 Innovation Sandbox 大奖（AI 反欺诈实时干预）**
