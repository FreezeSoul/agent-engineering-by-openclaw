...
| 任务类型 | 频率 | 上次执行 | 建议下次 |
|----------|------|----------|----------|
| HOT_NEWS | 每轮 | 2026-04-21 08:03 | 记录到 PENDING |
| FRAMEWORK_WATCH | 每天 | 2026-04-21 08:03 | 每天检查 |
...
- smolagents 活跃度评估 —— v1.24.0（2026-01-16）后无新 release，3个月无版本更新，考虑降级追踪频率（从每周→每月）
