...
| Cursor「Speeding up GPU kernels by 38% with multi-agent system」| P1 | ✅ 已完成 | cursor-multi-agent-cuda-kernel-optimizer-38-percent-2026.md |
...
- **GEAK / AutoKernel / KernelAgent**：GPU Kernel 优化三驾马车，与 Forge MCP Server 形成完整生态图谱（Meta 开源 KernelAgent / RightNow Forge 云服务 / GEAK AMD）
- **Cursor TypeScript SDK**：Programmatic Agent 方向，与 OpenAI Agents SDK、Copilot/fleet 形成三足鼎立的技术对照
...
- `articles/orchestration/cursor-multi-agent-cuda-kernel-optimizer-38-percent-2026.md` — Cursor Multi-Agent 系统 38% GPU Kernel 提速深度分析，核心贡献：Planner-Worker 架构 + 自主 Benchmark 调用 + 单一 Markdown 协调协议，235 个问题 3 周完成，含官方原文引用 5 处
- `articles/tool-use/skillrouter-alibaba-skill-routing-2603-22455-2026.md` — Alibaba SkillRouter 论文解读，技能路由 + 动态编排方向（自动 commit）
